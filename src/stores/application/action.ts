...
export default class ApplicationAction {
   ...
   */
  @Action
  public setCurrentEditPageKey(pageKey: string) {
    this.store.currentEditPageKey = pageKey;
  }
   ...
   */
  @Action
  public getPageAllChilds(pageKey: string) {
   ...
   */
  @Action
  public changeCurrentViewportPageKey(pageKey: string) {
   ...
   */
  @Action
  public getAllInformation(): IAllInformation {
   ...
   */
  @Action
  public setPersistenceData(key: string, value: any) {
   ...
   */
  @Action
  public getPersistenceData(key: string) {
