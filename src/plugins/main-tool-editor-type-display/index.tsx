...
class MainToolDisplay extends React.Component<Props, State> {
  ...
  public render() {
    ...
    const display = this.props.actions.ViewportAction.getInstanceProps(this.props.stores.ViewportStore.currentEditInstanceKey, "style.display") || "block"
  ...
  private handleUpdateValue = (field: string, value: any) => {
    this.props.actions.ViewportAction.setInstanceProps(this.props.stores.ViewportStore.currentEditInstanceKey, field, value)
  }
   ...
   */
  private renderFlex = () => {
    const flexDirection = this.props.actions.ViewportAction.getInstanceProps(this.props.stores.ViewportStore.currentEditInstanceKey, "style.flexDirection") || "row"
    const flexGrow = this.props.actions.ViewportAction.getInstanceProps(this.props.stores.ViewportStore.currentEditInstanceKey, "style.flexGrow") || 0
    const alignItems = this.props.actions.ViewportAction.getInstanceProps(this.props.stores.ViewportStore.currentEditInstanceKey, "style.alignItems") || "stretch"
    const justifyContent = this.props.actions.ViewportAction.getInstanceProps(this.props.stores.ViewportStore.currentEditInstanceKey, "style.justifyContent") || "flex-start"
        ...
        <S.FlexRow
          ...
          <ButtonGroup>
            ...
            <Tooltip mouseLeaveDelay={0} title={rowFlexCenter}>
              <ActiveButton active={justifyContent === "center"}
            ...
            <Tooltip mouseLeaveDelay={0} title={rowFlexEnd}>
              <ActiveButton active={justifyContent === "flex-end"}
            ...
            <Tooltip mouseLeaveDelay={0} title={rowFlexSpaceBetween}>
              <ActiveButton active={justifyContent === "space-between"}
            ...
            <Tooltip mouseLeaveDelay={0} title={rowFlexSpaceAround}>
              <ActiveButton active={justifyContent === "space-around"}
        ...
        <S.FlexRow
          ...
          <ButtonGroup>
            <Tooltip mouseLeaveDelay={0} title={columnFlexStart}>
              <ActiveButton active={alignItems === "flex-start"}
            ...
            <Tooltip mouseLeaveDelay={0} title={columnFlexCenter}>
              <ActiveButton active={alignItems === "center"}
            ...
            <Tooltip mouseLeaveDelay={0} title={columnFlexEnd}>
              <ActiveButton active={alignItems === "flex-end"}
            ...
            <Tooltip mouseLeaveDelay={0} title={columnFlexStrech}>
              <ActiveButton active={alignItems === "stretch"}
            ...
            <Tooltip mouseLeaveDelay={0} title={columnFlexBaseline}>
              <ActiveButton active={alignItems === "baseline"}
      ...
      <S.DisplayContainer>
        <ButtonGroup>
          <Tooltip mouseLeaveDelay={0} title="Block">
            <ActiveButton active={display === "block"}
          ...
          <Tooltip mouseLeaveDelay={0} title="InlineBlock">
            <ActiveButton active={display === "inline-block"}
          ...
          <Tooltip mouseLeaveDelay={0} title="Inline">
            <ActiveButton active={display === "inline"}
