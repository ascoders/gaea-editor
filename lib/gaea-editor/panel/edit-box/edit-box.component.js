...
var index_2 = require("../../../../../web-common/tabs/index");
...
var EditBox = function (_React$Component) {
    ...
    function EditBox() {
        ...
        var _this = _possibleConstructorReturn(this, (EditBox.__proto__ || Object.getPrototypeOf(EditBox)).apply(this, arguments));
