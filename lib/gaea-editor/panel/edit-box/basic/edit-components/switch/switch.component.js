...
var EditComponentSwitch = function (_React$Component) {
    ...
    function EditComponentSwitch() {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = EditComponentSwitch.__proto__ || Object.getPrototypeOf(EditComponentSwitch)).call.apply(_ref, [this].concat(args)));
    ...
    _createClass(EditComponentSwitch, [{
        ...
        value: function render() {
            ...
            var switchOpts = {
                ...
                checked: this.props.editOption.isNull ? this.props.editOption.notNullValue : this.componentInfo.props[this.props.editOption.field],
