...
var typings = require('./array.type');
...
var EditComponentText = function (_React$Component) {
    ...
    _createClass(EditComponentText, [{
        ...
        value: function handleAdd() {
            var field = this.componentInfo.props[this.props.editOption.field];
            if (field === null) {
                field = [];
            }
            field.push({});
        ...
        value: function render() {
            ...
            var field = this.componentInfo.props[this.props.editOption.field];
            var Element = field.constructor.name === 'Array' && field.map(function (item) {
                return React.createElement("div", null, "111");
            });
            return React.createElement("div", null, Element, React.createElement(index_1.default, { onClick: this.handleAdd.bind(this) }, "+"));
        }
    }]);
