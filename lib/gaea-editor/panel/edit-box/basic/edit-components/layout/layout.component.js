...
var EditComponentText = function (_React$Component) {
    ...
    (0, _createClass3.default)(EditComponentText, [{
        ...
        value: function renderFlex() {
            ...
            return React.createElement("div", null, React.createElement("div", { className: "layout-top-container", style: { marginTop: 5 } }, React.createElement(index_2.Tooltip, { title: "Direction:Row" }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.flexDirection === 'row' || this.componentInfo.props.style.flexDirection === 'row-reverse', onClick: this.handleUpdateValue.bind(this, 'style.flexDirection', 'row') }, "Row")), React.createElement(index_1.ButtonGroup, null, React.createElement(index_2.Tooltip, { title: rowFlexStart }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.justifyContent === 'flex-start', onClick: this.handleUpdateValue.bind(this, 'style.justifyContent', 'flex-start') }, React.createElement("svg", { className: "svg-icon rotate-90" }, React.createElement("use", { xlinkHref: "#icon-flex-align" })))), React.createElement(index_2.Tooltip, { title: rowFlexCenter }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.justifyContent === 'center', onClick: this.handleUpdateValue.bind(this, 'style.justifyContent', 'center') }, React.createElement("svg", { className: "svg-icon rotate-90" }, React.createElement("use", { xlinkHref: "#icon-flex-center-vertical" })))), React.createElement(index_2.Tooltip, { title: rowFlexEnd }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.justifyContent === 'flex-end', onClick: this.handleUpdateValue.bind(this, 'style.justifyContent', 'flex-end') }, React.createElement("svg", { className: "svg-icon rotate-270" }, React.createElement("use", { xlinkHref: "#icon-flex-align" })))), React.createElement(index_2.Tooltip, { title: rowFlexSpaceBetween }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.justifyContent === 'space-between', onClick: this.handleUpdateValue.bind(this, 'style.justifyContent', 'space-between') }, "B")), React.createElement(index_2.Tooltip, { title: rowFlexSpaceAround }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.justifyContent === 'space-around', onClick: this.handleUpdateValue.bind(this, 'style.justifyContent', 'space-around') }, "A")))), React.createElement("div", { className: "layout-top-container", style: { marginTop: 5 } }, React.createElement(index_2.Tooltip, { title: "Direction:Column" }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.flexDirection === 'column' || this.componentInfo.props.style.flexDirection === 'column-reverse', onClick: this.handleUpdateValue.bind(this, 'style.flexDirection', 'column') }, "Column")), React.createElement(index_1.ButtonGroup, null, React.createElement(index_2.Tooltip, { title: columnFlexStart }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.alignItems === 'flex-start', onClick: this.handleUpdateValue.bind(this, 'style.alignItems', 'flex-start') }, "S")), React.createElement(index_2.Tooltip, { title: columnFlexCenter }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.alignItems === 'center', onClick: this.handleUpdateValue.bind(this, 'style.alignItems', 'center') }, "C")), React.createElement(index_2.Tooltip, { title: columnFlexEnd }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.alignItems === 'flex-end', onClick: this.handleUpdateValue.bind(this, 'style.alignItems', 'flex-end') }, "E")), React.createElement(index_2.Tooltip, { title: columnFlexStrech }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.alignItems === 'stretch', onClick: this.handleUpdateValue.bind(this, 'style.alignItems', 'stretch') }, "B")), React.createElement(index_2.Tooltip, { title: columnFlexBaseline }, React.createElement(index_1.Button, { active: this.componentInfo.props.style.alignItems === 'baseline', onClick: this.handleUpdateValue.bind(this, 'style.alignItems', 'baseline') }, "A")))), React.createElement("div", { className: "second-container" }, React.createElement(index_3.Checkbox, { checked: isReverse, onChange: this.handleChangeReverse.bind(this), style: { marginTop: 5, flexGrow: 1, width: 0 } }, "逆序"), React.createElement("div", { className: "second-container-flex-grow-container" }, React.createElement("span", null, "Grow"), React.createElement(index_4.Number, { label: "", onChange: this.handleFlexGrowChange.bind(this), value: flexGrowString }))));
        }
    }, {
        key: "renderDisplay",
