...
const index_3 = require('../../../../../../../../web-common/checkbox/index');
const index_4 = require('../../../../../../../../web-common/number/index');
require('./layout.scss');
let EditComponentText = class EditComponentText extends React.Component {
    ...
    render() {
        return (React.createElement("div", {className: "_namespace"}, !this.props.application.isReactNative && this.renderDisplay(), (this.componentInfo.props.style.display === 'flex' || this.props.application.isReactNative) && this.renderFlex()));
    }
};
