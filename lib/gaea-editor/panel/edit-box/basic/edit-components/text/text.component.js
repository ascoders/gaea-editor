    ...
    _createClass(EditComponentText, [{
        ...
        value: function render() {
            ...
            var textOpts = {
                ...
                value: this.props.editOption.isNull ? this.props.editOption.notNullValue : this.componentInfo.props[this.props.editOption.field],
                onChange: function onChange(event) {
                    _this2.props.viewport.updateComponentOptionsValue(_this2.props.editOption, event.target.value);
                }
            };
