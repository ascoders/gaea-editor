...
var EditBoxBasic = function (_React$Component) {
    ...
    (0, _createClass3.default)(EditBoxBasic, [{
        ...
        key: "handleConfirmEditProps",
        value: function handleConfirmEditProps() {
            var eventData = this.props.viewport.currentEditIsWeb ? 'gaeaEventData' : 'gaeaNativeEventData';
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-panel-edit_box-basic" }, this.props.viewport.currentEditPropsIndex === null && React.createElement("div", { className: "basic-title-container" }, React.createElement("div", { className: "component-icon-container" }, React.createElement("i", { className: "fa fa-" + this.componentInfo.props.gaeaIcon })), React.createElement(index_3.default, { className: "title-name", label: "", normal: true, key: this.props.viewport.currentEditComponentMapUniqueKey, onChange: this.handleChangeName, rightRender: this.titleInputRightRender, value: this.componentInfo.props.gaeaName })), this.props.viewport.currentEditPropsIndex !== null && React.createElement("div", { className: "basic-title-container" }, React.createElement(index_2.Button, { type: "primary", rounded: true, onClick: this.handleConfirmEditProps.bind(this) }, "确认")), React.createElement("div", { className: "edit-item-container" }, Editors), this.props.viewport.currentEditPropsIndex === null && React.createElement("div", { className: "bottom-addon" }, React.createElement(index_2.ButtonGroup, null, ResetButton, GroupButton)));
        }
    }]);
    return EditBoxBasic;
}(React.Component);
...
__decorate([index_1.autoBindMethod], EditBoxBasic.prototype, "handleConfirmEditProps", null);
