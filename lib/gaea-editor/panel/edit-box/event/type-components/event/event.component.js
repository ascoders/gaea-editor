...
var Event = function (_React$Component) {
    ...
    (0, _createClass3.default)(Event, [{
        ...
        value: function render() {
            ...
            var customData = this.props.isWeb ? this.componentInfo.props.gaeaEventData[this.props.index].typeData : this.componentInfo.props.gaeaNativeEventData[this.props.index].typeData;
            var datas = this.props.viewport.getEventListName().map(function (name) {
                return {
                    text: name,
                    value: name
                };
