...
var Event = function (_React$Component) {
    ...
    (0, _createClass3.default)(Event, [{
        ...
        value: function render() {
            ...
            var customData = this.componentInfo.props.gaeaEventData[this.props.index].typeData;
            return React.createElement(index_1.default, { value: customData.listen || '', label: "监听的事件名称", onChange: this.handleChange.bind(this), onSelect: this.handleChange.bind(this) });
        }
    }]);
    return Event;
}(React.Component);
