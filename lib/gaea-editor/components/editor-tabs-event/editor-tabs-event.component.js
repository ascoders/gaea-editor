...
var EditorTabsEvent = function (_React$Component) {
    ...
    (0, _createClass3.default)(EditorTabsEvent, [{
        ...
        value: function renderEventEditor(eventData) {
            ...
            var typeOptions = this.props.ViewportStore.currentEditComponentInfo.props.gaeaEvent && this.props.ViewportStore.currentEditComponentInfo.props.gaeaEvent.types ? this.props.ViewportStore.currentEditComponentInfo.props.gaeaEvent.types.map(function (type, index) {
                return {
                    key: index.toString(),
                    value: type.name
                };
            ...
            var eventOptions = this.props.ViewportStore.currentEditComponentInfo.props.gaeaEvent && this.props.ViewportStore.currentEditComponentInfo.props.gaeaEvent.events ? this.props.ViewportStore.currentEditComponentInfo.props.gaeaEvent.events.map(function (event, index) {
                return {
                    key: index.toString(),
                    value: event.name
                };
