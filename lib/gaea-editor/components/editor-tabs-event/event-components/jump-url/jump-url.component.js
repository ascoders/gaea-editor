...
__decorate([EditorManager.lazyInject(action_1.default)], JumpUrl.prototype, "eventAction", void 0);
JumpUrl = __decorate([mobx_react_1.inject('ViewportStore', 'EditorEventAction'), mobx_react_1.observer], JumpUrl);
