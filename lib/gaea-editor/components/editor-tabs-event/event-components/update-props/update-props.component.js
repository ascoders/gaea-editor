    ...
    (0, _createClass3.default)(UpdatePropsEvent, [{
        ...
        value: function handleClick() {
            ...
            if (this.props.EditorEventStore.currentEditPropsIndex !== this.props.index) {
                ...
                var _cleanProps = this.props.ApplicationAction.cleanComponentProps(this.props.ViewportStore.currentEditComponentInfo.props);
                this.props.ViewportAction.updateCurrentEditComponentProps(eventData + "." + this.props.index + ".eventData.props", _cleanProps);
        ...
        value: function render() {
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-components-editor_tabs_event-event_components-update_props" }, React.createElement(index_1.Button, { active: this.props.EditorEventStore.currentEditPropsIndex === this.props.index, onClick: this.handleClick.bind(this) }, React.createElement("i", { className: "fa fa-pencil", style: { marginRight: 5 } }), "修改属性"));
        }
    }]);
    return UpdatePropsEvent;
}(React.Component);
UpdatePropsEvent.defaultProps = new typings.Props();
UpdatePropsEvent = __decorate([mobx_react_1.inject('ViewportStore', 'EditorEventAction', 'EditorEventStore', 'ApplicationAction', 'ViewportAction'), mobx_react_1.observer], UpdatePropsEvent);
