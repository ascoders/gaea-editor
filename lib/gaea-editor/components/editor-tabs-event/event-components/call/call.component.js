...
var Call = function (_React$Component) {
    ...
    (0, _createClass3.default)(Call, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", null, React.createElement(index_1.default, { style: { marginBottom: 8 }, value: customData.functionName, onChange: this.handleChange.bind(this), label: "自定义命令" }), React.createElement(index_2.default, { onClick: this.handleChange.bind(this, 'back'), active: customData.functionName === 'back' }, "回退"), React.createElement(index_2.default, { style: { marginLeft: 5 }, onClick: this.handleChange.bind(this, 'close'), active: customData.functionName === 'close' }, "关闭"));
        }
    }]);
    return Call;
}(React.Component);
