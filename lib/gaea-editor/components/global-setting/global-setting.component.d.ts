...
export default class GlobalSetting extends React.Component<typings.PropsDefine, typings.StateDefine> {
    ...
    handleSwitchShowTimeUnlimited(): void;
    handleSwitchShowTimeLimited(): void;
    handleChangeStartDate(event: any): void;
    handleChangeStartTime(event: any): void;
    handleChangeEndDate(event: any): void;
    handleChangeEndTime(event: any): void;
    handleChangeCustomSetting(key: string, value: string): void;
    render(): JSX.Element;
}
