...
__decorate([gaea_editor_manager_1.action('增加外部传参')], GlobalSettingAction.prototype, "addExternalParameter", null);
__decorate([gaea_editor_manager_1.action('删除外部传参')], GlobalSettingAction.prototype, "removeExternalParameter", null);