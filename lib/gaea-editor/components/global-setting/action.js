...
var GlobalSettingAction = function () {
    ...
    (0, _createClass3.default)(GlobalSettingAction, [{
        key: "changeCustomSetting",
        value: function changeCustomSetting(key, value) {
            this.globalSetting[key] = value;
        }
    }, {
        ...
        value: function changeShowTimeLimited() {
            ...
            var endDate = arguments.length <= 1 || arguments[1] === undefined ? new Date((new Date().getTime() / 1000 + 86400) * 1000) : arguments[1];
        ...
        value: function changeShowTime(startOrEnd, dateOrTime, value) {
            ...
            var startDate = new Date(this.globalSetting.showTimeStartDate + ' ' + this.globalSetting.showTimeStartTime);
            var endDate = new Date(this.globalSetting.showTimeEndDate + ' ' + this.globalSetting.showTimeEndTime);
...
__decorate([gaea_editor_manager_1.action('修改任意配置信息')], GlobalSettingAction.prototype, "changeCustomSetting", null);
