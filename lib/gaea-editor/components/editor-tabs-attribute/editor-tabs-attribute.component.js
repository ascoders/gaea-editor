        ...
        value: function render() {
            ...
            var EditItems = this.props.ViewportStore.currentEditComponentInfo.props.gaeaEdit && this.props.ViewportStore.currentEditComponentInfo.props.gaeaEdit.map(function (editInfo, index) {
                if (editInfo.constructor.name === 'String') {
                    return React.createElement("div", { key: index, className: "title" }, editInfo.toString());
                } else {
                    return React.createElement("div", { key: index }, _this2.props.ApplicationAction.loadingPluginByPosition("editorAttribute" + _.upperFirst(_.camelCase(editInfo.editor)), {
                        editInfo: editInfo
                    }));
                }
            });
