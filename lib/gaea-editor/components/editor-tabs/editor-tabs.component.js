...
var EditorTabs = function (_React$Component) {
    ...
    (0, _createClass3.default)(EditorTabs, [{
        ...
        value: function render() {
            ...
            var attributeName = this.props.EventStore.currentEditPropsIndex === null ? '属性' : '修改属性';
...
EditorTabs = __decorate([EditorManager.observer(['ViewportStore', 'EventStore', 'ApplicationAction'])], EditorTabs);
