...
var ShowLayoutButton = function (_React$Component) {
    ...
    (0, _createClass3.default)(ShowLayoutButton, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: classes, onClick: this.handleClick }, React.createElement("i", { className: "fa fa-eye" }));
        }
    }]);
    return ShowLayoutButton;
}(React.Component);
ShowLayoutButton.defaultProps = new typings.Props();
ShowLayoutButton.position = 'navbarLeftBottom';
