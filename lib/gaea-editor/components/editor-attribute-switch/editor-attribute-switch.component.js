...
var typings = require("./editor-attribute-switch.type");
...
require("./editor-attribute-switch.css");
var EditorAttributeSelect = function (_React$Component) {
    ...
    (0, _createClass3.default)(EditorAttributeSelect, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-components-editor_attribute_switch" }, React.createElement("div", { className: "label" }, this.props.editInfo.label), React.createElement("div", { className: "input-container" }, React.createElement(index_1.Switch, __assign({}, switchOpts))));
        }
    }]);
    return EditorAttributeSelect;
}(React.Component);
EditorAttributeSelect.defaultProps = new typings.Props();
EditorAttributeSelect.position = 'editorAttributeSwitch';
