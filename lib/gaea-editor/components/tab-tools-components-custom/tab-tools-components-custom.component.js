...
var typings = require("./tab-tools-components-custom.type");
var EditorManager = require("../../../gaea-editor-manager/gaea-editor-manager");
require("./tab-tools-components-custom.css");
var TabToolsComponentsCommon = function (_React$Component) {
    ...
    (0, _createClass3.default)(TabToolsComponentsCommon, [{
        ...
        value: function render() {
            var CommonDraggableItems = this.props.ApplicationStore.customComponents.map(function (ComponentClass, index) {
            ...
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-components-tab_tools_components_custom" }, CommonDraggableItems);
        }
    }]);
    return TabToolsComponentsCommon;
}(React.Component);
TabToolsComponentsCommon.defaultProps = new typings.Props();
TabToolsComponentsCommon.position = 'tabToolsComponentsCustom';
