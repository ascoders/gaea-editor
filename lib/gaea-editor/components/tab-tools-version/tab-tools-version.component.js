    ...
    (0, _createClass3.default)(TabToolsVersion, [{
        ...
        value: function handlePreviewVersion(version) {
            ...
            this.props.ApplicationStore.editorProps.onPreviewVersion(version, function (content) {
                ...
                _this3.props.EventAction.emit(_this3.props.EventStore.refreshPage);
            });
        }
    }, {
...
TabToolsVersion = __decorate([EditorManager.observer(['TabToolsVersionStore', 'ApplicationStore', 'ApplicationAction', 'TabToolsVersionAction', 'EventStore', 'EventAction'])], TabToolsVersion);
