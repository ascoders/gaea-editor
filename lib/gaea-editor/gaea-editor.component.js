...
var GaeaEditor = function (_React$Component) {
    ...
    _createClass(GaeaEditor, [{
        ...
        value: function render() {
            return React.createElement(mobx_react_1.Provider, { application: this.applicationStore, viewport: this.viewport, setting: this.setting }, React.createElement(page_component_1.default, { ref: this.getRootRef.bind(this) }));
        }
    }]);
