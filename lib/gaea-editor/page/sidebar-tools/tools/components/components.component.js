...
var Components = function (_React$Component) {
    ...
    _createClass(Components, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-page-sidebar_tools-tools-components components-container" }, React.createElement("div", { className: "container", ref: this.setDragContainerInstance }, DragComponents), React.createElement("div", { className: "switch" }, React.createElement(index_2.ButtonGroup, { className: "button-group", vertical: true }, SwitchButtonGroup)), React.createElement(index_3.Modal, { className: "nt-editor-gaea-editor-gaea_editor-page-sidebar_tools-tools-components", show: this.state.showExportModal, onCancel: this.handleCancelExportModal.bind(this), onOk: this.handleCancelExportModal.bind(this), title: this.state.exportComponentInfo && this.state.exportComponentInfo.name }, this.state.exportComponentInfo && React.createElement("div", null, React.createElement("textarea", { className: "export-textarea", onChange: function onChange() {}, value: JSON.stringify(this.state.exportComponentInfo) }), "复制输入框中的内容，并截图组件，发送给 huangziyi01@baidu.com，通过审核后您的组合会出现在左侧模板区域中（必须完全由基础组件组成）。")));
        }
    }]);
