...
var Color = function (_React$Component) {
    ...
    _createClass(Color, [{
        ...
        value: function componentWillMount() {
            this.props.application.event.on(this.props.application.event.settingShadowClose, this.handleSettingShadowClose);
        }
    }, {
        key: "componentWillUnmount",
        value: function componentWillUnmount() {
            this.props.application.event.off(this.props.application.event.settingShadowClose, this.handleSettingShadowClose);
        }
    }, {
        key: "handleSettingShadowClose",
        value: function handleSettingShadowClose() {
            this.handleClose();
        }
    }, {
        ...
        value: function handleColorPickerClick() {
            ...
            this.setState({
                ...
                _this2.props.viewport.setShowSettingShadow(true);
            });
        }
    }, {
        key: "handleClose",
...
__decorate([index_1.autoBindMethod], Color.prototype, "handleSettingShadowClose", null);
