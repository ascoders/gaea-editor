...
var Template = function (_React$Component) {
    ...
    _createClass(Template, [{
        ...
        value: function render() {
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-page-left_bar-template" }, React.createElement("div", { className: "title" }, "卡片"));
        }
    }]);
...
Template = __decorate([mobx_react_1.inject('setting'), mobx_react_1.observer], Template);
