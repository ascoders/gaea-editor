    ...
    (0, _createClass3.default)(EditHelper, [{
        ...
        value: function setDragableClassIfNeed() {
            if (!this.componentInfo.props.style || !this.componentInfo.props.style.position) {
                if (!dom_1.hasClass(this.domInstance, 'gaea-draggable')) {
                    this.domInstance.className += ' gaea-draggable';
                }
                return;
            }
            if (this.componentInfo.props.style.position !== 'absolute' && !dom_1.hasClass(this.domInstance, 'gaea-draggable')) {
                this.domInstance.className += ' gaea-draggable';
            } else if (this.componentInfo.props.style.position === 'absolute' && dom_1.hasClass(this.domInstance, 'gaea-draggable')) {
