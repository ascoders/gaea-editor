    ...
    _createClass(Page, [{
        ...
        value: function componentWillMount() {
            ...
            if (_.isEmpty(this.props.application.defaultValue)) {
                ...
                var layoutProps = _.cloneDeep(LayoutClass.defaultProps);
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-page", style: { height: this.props.application.height } }, React.createElement("div", { style: { width: this.props.application.sidebarWidth }, className: "sidebar" }, React.createElement(sidebar_tools_component_1.default, null), React.createElement(sidebar_tools_preview_component_1.default, null), React.createElement(viewport_sidebar_resize_component_1.default, null)), React.createElement("div", { className: sectionClasses }, React.createElement(header_component_1.default, null), React.createElement("div", { className: "section-container", ref: this.getSectionContainerRef, style: { height: "calc(100% - " + (this.props.application.headerHeight + this.props.application.footerHeight) + "px)" } }, React.createElement(left_bar_component_1.default, null), React.createElement("div", { className: "viewport-main-container" }, React.createElement("div", { className: "viewport-main-content", style: { width: this.props.application.viewportWidth + "%" } }, React.createElement(viewport_component_1.default, null), React.createElement(outer_move_box_component_1.default, null), this.props.application.isPreview && React.createElement("div", { className: "preview-container" }, React.createElement(index_2.default, { value: this.props.viewport.getIncrementComponentsInfo(), baseComponents: this.props.application.baseComponents, customComponents: this.props.application.customComponents })))), React.createElement(sidebar_addon_component_1.default, null)), React.createElement(footer_component_1.default, null)));
        }
    }]);
