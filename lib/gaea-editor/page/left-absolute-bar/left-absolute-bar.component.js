...
var LeftAbsoluteBar = function (_React$Component) {
    ...
    (0, _createClass3.default)(LeftAbsoluteBar, [{
        ...
        value: function toggleShowTemplate(leftBarName) {
        ...
        value: function render() {
            ...
            var externalParameterClasses = classNames({
                'menu-item': true,
                'active': this.state.currentName === 'externalParameter'
            });
            var globalVariableClasses = classNames({
                'menu-item': true,
            ...
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-page-left_absolute_bar" }, React.createElement("div", { className: "top" }, React.createElement(index_1.Tooltip, { position: "right", title: "模板列表" }, React.createElement("div", { className: templateClasses, onClick: this.toggleShowTemplate.bind(this, 'template') }, React.createElement("i", { className: "fa fa-list-alt" }))), React.createElement(index_1.Tooltip, { position: "right", title: "外部参数" }, React.createElement("div", { className: externalParameterClasses, onClick: this.toggleShowTemplate.bind(this, 'externalParameter') }, React.createElement("i", { className: "fa fa-paper-plane-o" }))), React.createElement(index_1.Tooltip, { position: "right", title: "全局变量" }, React.createElement("div", { className: globalVariableClasses, onClick: this.toggleShowTemplate.bind(this, 'globalVariable') }, React.createElement("i", { className: "fa fa-globe" })))), React.createElement("div", { className: "bottom" }, React.createElement(index_1.Tooltip, { position: "right", title: "显示空布局块" }, React.createElement("div", { className: showLayoutClasses, onClick: this.toggleShowLayoutBorder.bind(this) }, React.createElement("i", { className: "fa fa-eye" })))));
        }
    }]);
