...
var LeftAbsoluteBar = function (_React$Component) {
    ...
    function LeftAbsoluteBar() {
        ...
        var _this = _possibleConstructorReturn(this, (_ref = LeftAbsoluteBar.__proto__ || Object.getPrototypeOf(LeftAbsoluteBar)).call.apply(_ref, [this].concat(args)));
    ...
    _createClass(LeftAbsoluteBar, [{
        ...
        value: function render() {
            ...
            return React.createElement("div", { className: "nt-editor-gaea-editor-gaea_editor-page-left_absolute_bar" }, React.createElement("div", { className: "top" }, React.createElement("div", { className: templateClasses, onClick: this.toggleShowTemplate.bind(this) }, React.createElement("i", { className: "fa fa-list-alt" }))), React.createElement("div", { className: "bottom" }, React.createElement("div", { className: showLayoutClasses, onClick: this.toggleShowLayoutBorder.bind(this) }, React.createElement("i", { className: "fa fa-eye" }))));
        }
    }]);
