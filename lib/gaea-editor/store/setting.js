...
__decorate([mobx_1.observable], SettingStore.prototype, "viewportHeight", void 0);
__decorate([mobx_1.observable], SettingStore.prototype, "fitInWeb", void 0);
__decorate([mobx_1.observable], SettingStore.prototype, "globalParams", void 0);
...
var Setting = function () {
    ...
    (0, _createClass3.default)(Setting, [{
        ...
        key: "addGlobalParam",
        value: function addGlobalParam(globalParam) {
            this.data.globalParams.push(globalParam);
        }
    }, {
        key: "removeGlobalParam",
        value: function removeGlobalParam(index) {
...
__decorate([mobx_1.action('设置视图区域宽度')], Setting.prototype, "setViewportSize", null);
__decorate([mobx_1.action('修改网页适配')], Setting.prototype, "changeFitInWeb", null);
__decorate([mobx_1.action('增加全局变量配置')], Setting.prototype, "addGlobalParam", null);
__decorate([mobx_1.action('删除全局变量配置')], Setting.prototype, "removeGlobalParam", null);