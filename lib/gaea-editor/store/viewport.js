...
var Viewport = function () {
    ...
    (0, _createClass3.default)(Viewport, [{
        ...
        key: "addEvent",
        value: function addEvent(mapUniqueKey) {
            var componentInfo = this.components.get(mapUniqueKey);
        ...
        key: "removeEvent",
        value: function removeEvent(mapUniqueKey, index) {
            var componentInfo = this.components.get(mapUniqueKey);
            componentInfo.props.gaeaEventData.splice(index, 1);
        }
    }, {
        key: "updateEventTriggerCondition",
        value: function updateEventTriggerCondition(mapUniqueKey, dataIndex, typeIndex) {
            var componentInfo = this.components.get(mapUniqueKey);
        ...
        value: function updateEventAction(mapUniqueKey, dataIndex, eventIndex) {
            var componentInfo = this.components.get(mapUniqueKey);
