    ...
    _createClass(Viewport, [{
        ...
        value: function setComponents(mapUniqueKey, componentInfo) {
            if (componentInfo.props.gaeaEdit) {
                componentInfo.props.gaeaEdit = componentInfo.props.gaeaEdit.map(function (gaeaEdit) {
                    if (['marginPadding'].findIndex(function (name) {
                        return name === gaeaEdit.editor;
                    }) > -1) {
        ...
        value: function getIncrementComponentsInfo() {
            ...
            Object.keys(cloneComponents).map(function (key) {
                ...
                var defaultProps = _this3.application.getComponentByUniqueKey(cloneComponents[key].props.gaeaUniqueKey).defaultProps;
                if (cloneComponents[key].props.name == defaultProps.name) {
                    delete cloneComponents[key].props.name;
                }
                var props = cloneComponents[key].props;
                props && Object.keys(props).forEach(function (propsKey) {
        ...
        value: function addNewComponent(mapUniqueKey, parentMapUniqueKey, uniqueId, index) {
            ...
            mobx_1.transaction(function () {
                _this4.setComponents(mapUniqueKey, component);
            });
        ...
        value: function addComplexComponent(parentMapUniqueKey, mapUniqueKey, index, componentFullInfo) {
            ...
            Object.keys(componentFullInfo.childs).forEach(function (childMapUniqueKey) {
                _this5.setComponents(childMapUniqueKey, JSON.parse(JSON.stringify(componentFullInfo.childs[childMapUniqueKey])));
            });
        ...
        value: function createCopyComponentWithNewUniqueKey(originComponent, parentMapUniqueKey) {
            ...
            Object.keys(originComponent.childs).forEach(function (mapUniqueKey) {
                ...
                childs[uniqueKeyMap.get(mapUniqueKey)] = {
                    ...
                    layoutChilds: originChild.layoutChilds.map(function (childMapUniqueKey) {
            ...
            var newCopyComponent = {
                ...
                componentInfo: {
                    ...
                    layoutChilds: originComponent.componentInfo.layoutChilds.map(function (childMapUniqueKey) {
                        return uniqueKeyMap.get(childMapUniqueKey);
                    })
                },
                childs: childs
